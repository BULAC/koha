...
<xsl:template match="marc:record">
  ...
  <div id="views">
    ...
    <span class="view">
      <a id="MARCviewPop" href="/cgi-bin/koha/opac-showmarc.pl?id={$biblionumber}" title="MARC" rel="gb_page_center[600,500]">MARC View</a>
    </span>
    <span class="view">
      <a id="MARCview" href="/cgi-bin/koha/opac-MARCdetail.pl?biblionumber={$biblionumber}" title="MARC">Expanded MARC View</a>
    </span>
    <span class="view">
      <a id="ISBDview" href="/cgi-bin/koha/opac-ISBDdetail.pl?biblionumber={$biblionumber}">Card View (ISBD)</a>
    </span>
  </div>
