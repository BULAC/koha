...
# change these arrays if new types of transaction or new parameters are allowed
    my @allowed_keys = qw (type branch amount other itemnumber itemtype borrowernumber accountno ccode associatedborrower);
    my @allowed_circulation_types = qw (renew issue localuse return onsite_checkout editedreserve askedfromstacks putaside reserved cardcatalog periogen chkedinwai chkedinfst);
